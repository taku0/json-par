...
(defvar json-par-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (json-par-define-special-key map "o" #'exchange-point-and-mark)
    (json-par-define-special-key map "b" #'json-par-pop-region)
    ...
    (json-par-define-special-key map "u" #'universal-argument)
